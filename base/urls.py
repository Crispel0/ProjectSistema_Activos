...
urlpatterns = [
    ...
    path("cambio_contrasena/completado",auth_views.PasswordChangeDoneView.as_view(template_name="administrador/cambio_contrasena_hecho.html"),name="cambio_contrasena_hecho",),
