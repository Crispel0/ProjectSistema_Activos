...
urlpatterns = [
    ...
    path("adminsitar_software/agregar_sistema_operativo/<int:pk>", editar_sistema_operativo, name="agregar_sistema_operativo"),
    ...
    path ('adminsitar_software/agregar_version_sistema_operativo/<int:pk>', editar_version_sistema_operativo, name="editar_version_sistema_operativo"),
