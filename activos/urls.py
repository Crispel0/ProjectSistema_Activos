...
urlpatterns = [
    ...
    path("adminsitar_ofimatica/editar_paquete_ofimatica/<int:pk>", editar_paquete_ofimatica, name="editar_paquete_ofimatica"),
    ...
    path ("adminsitar_software/editar_sistema_operativo/<int:pk>", editar_sistema_operativo, name="editar_sistema_operativo"),
    ...
    path ('adminsitar_software/eliminar_version_sistema_operativo/<int:pk>', eliminar_version_sistema_operativo, name="eliminar_version_sistema_operativo"),
    path ('adminsitar_software/editar_version_sistema_operativo/<int:pk>', editar_version_sistema_operativo, name="editar_version_sistema_operativo"),
